...
describe('listTodos', () => {
  ...
  it('should return status code 200 with a collection of Todo Items', async () => {
    ...
    const result = await listTodos(APIGatewayProxyEventCollectionMock, TodoServiceMock, Logger);
  ...
  it('should call logger.info with correct params', async () => {
    await listTodos(APIGatewayProxyEventCollectionMock, TodoServiceMock, Logger);
