import { TodoRepositoryMock, APIGatewayProxyEventCollectionMock  } from "../__mocks__";
...
describe('listTodos', () => {
  ...
  it('should return status code 200 with a collection of Todo Items', async () => {
    TodoRepositoryMock.findAll.mockResolvedValue(APIGatewayProxyEventCollectionMock.body);
